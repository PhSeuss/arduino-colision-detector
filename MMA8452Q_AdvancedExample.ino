...
void initMMA8452(byte fsr, byte dataRate)
{
  ...
  writeRegister(0x23, 0x7e);  // 2. x thresh at 2g, multiply the value by 0.0625g/LSB to get the threshold
  writeRegister(0x24, 0x7e);  // 2. y thresh at 2g, multiply the value by 0.0625g/LSB to get the threshold
  writeRegister(0x25, 0x7e);  // 2. z thresh at .5g, multiply the value by 0.0625g/LSB to get the threshold
